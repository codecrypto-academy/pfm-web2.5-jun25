...
describe('DockerManager', () => {
  ...
  describe('createNetwork', () => {
    it('debe crear una red con los parámetros correctos', async () => {
      ...
      mockDocker.createNetwork = jest.fn().mockResolvedValue(mockNetwork);
    ...
    it('debe manejar errores al crear una red', async () => {
      ...
      mockDocker.createNetwork = jest.fn().mockRejectedValue(new Error('Error de prueba'));
  ...
  describe('createContainer', () => {
    ...
    it('debe manejar errores al crear un contenedor', async () => {
      // Configurar el mock para lanzar un error
      mockDocker.createContainer = jest.fn().mockRejectedValue(new Error('Error de prueba'));
  ...
  describe('removeContainer', () => {
    ...
    it('debe manejar errores al eliminar un contenedor', async () => {
      // Configurar el mock para lanzar un error
      const mockContainer = {
        remove: jest.fn().mockRejectedValue(new Error('Error de prueba'))
      };
      mockDocker.getContainer = jest.fn().mockReturnValue(mockContainer);
  ...
  describe('removeContainersInNetwork', () => {
    ...
    it('debe manejar errores al eliminar contenedores de una red', async () => {
      // Configurar el mock para lanzar un error
      const mockNetwork = {
        inspect: jest.fn().mockRejectedValue(new Error('Error de prueba'))
      };
      mockDocker.getNetwork = jest.fn().mockReturnValue(mockNetwork);
